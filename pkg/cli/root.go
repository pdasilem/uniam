...
func init() {
	...
	rootCmd.SetHelpFunc(func(cmd *cobra.Command, args []string) {
		...
		fmt.Fprintln(cmd.OutOrStdout(), "      --searxng        add the optional SearXNG MCP server during setup")
		fmt.Fprintln(cmd.OutOrStdout(), "      --brave-search   add the optional Brave Search MCP server during setup")
		fmt.Fprintln(cmd.OutOrStdout(), "      --firecrawl      add the optional Firecrawl MCP server during setup")
